...
| 3. Пройти 30-вопросный тест готовности | [Тест готовности](tools/risk-profile.md) — прямо в браузере | 20 мин |
| 4. Установить Python (не обязательно: сайт работает и без него) | См. [инструкцию](КАК-ПОЛЬЗОВАТЬСЯ.md) | 30 мин |
